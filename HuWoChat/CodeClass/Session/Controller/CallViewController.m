...
- (void)_setupSubviews
{
    ...
    _silenceLabel.text = NSLocalizedString(@"静音", @"Silence");
    ...
    _speakerOutLabel.text = NSLocalizedString(@"扬声器", @"Speaker");
    ...
    [_hangupButton setTitle:NSLocalizedString(@"取消", @"Hangup") forState:UIControlStateNormal];
